...
public class TileEntityBallisticMissileLauncher extends TileEntityLoadedBase implements ISidedInventory, IEnergyUser {
	...
	public TileEntityBallisticMissileLauncher() {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName : "container.BallisticMissileLauncher";
	}
	...
	public void updateEntity() {
		...
		if(!worldObj.isRemote) {
			...
			PacketRegistry.wrapper.sendToAllAround(new TEBallisticMissileLauncherMissilePacket(xCoord, yCoord, zCoord, slots[0]), new TargetPoint(worldObj.provider.dimensionId, xCoord, yCoord, zCoord, 250));
