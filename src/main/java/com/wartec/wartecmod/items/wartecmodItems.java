...
public class wartecmodItems {
    ...
    public static void initializeItem() {
        ...
        itemCruiseMissileDecoy = new ItemCruiseMissileSubsonic(EntityCruiseMissileDecoy.class).setCreativeTab(wartecmod.tabwartecmodcruisemissiles).setUnlocalizedName("ItemCruiseMissileDecoy").setTextureName("wartecmod:ItemCruiseMissileDecoy");
