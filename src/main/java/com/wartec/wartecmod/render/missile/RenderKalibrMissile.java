...
public class RenderKalibrMissile extends Render {
	
	public RenderKalibrMissile() { }
	...
	public void doRender(Entity missile, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        ...
        bindTexture(ResourceManager.entity_Kalibr_Missile_tex);
        ...
        if(missile.getDataWatcher().getWatchableObjectInt(9) == 1) {
        	...
        	ResourceManager.entity_Kalibr_Missile_Valves.renderAll();
        }
        if(missile.getDataWatcher().getWatchableObjectInt(9) == 2) {
        	ResourceManager.entity_Kalibr_Missile_Wings.renderAll();
        	ResourceManager.entity_Kalibr_Missile_Fins.renderAll();      	
        }
	...
	protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return ResourceManager.entity_Kalibr_Missile_tex;
	}
