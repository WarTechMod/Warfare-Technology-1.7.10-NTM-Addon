...
public class RenderSupersonicCruiseMissileH extends Render {
	
	public RenderSupersonicCruiseMissileH() { }
	...
	public void doRender(Entity missile, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        ...
        bindTexture(ResourceManager.entity_Supersonic_Cruise_Missile_Fuselage_H_tex);
