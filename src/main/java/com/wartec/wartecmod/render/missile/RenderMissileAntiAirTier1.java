...
public class RenderMissileAntiAirTier1 extends Render {
	
	public RenderMissileAntiAirTier1() { }
	...
	public void doRender(Entity missile, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        ...
        bindTexture(ResourceManager.entity_Missile_Anti_Air_Tier1_tex);
	...
	protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return ResourceManager.entity_Missile_Anti_Air_Tier1_tex;
	}
