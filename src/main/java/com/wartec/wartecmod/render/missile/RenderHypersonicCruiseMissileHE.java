...
public class RenderHypersonicCruiseMissileHE extends Render {
	
	public RenderHypersonicCruiseMissileHE() { }
	...
	protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return ResourceManager.entity_Hypersonic_Cruise_Missile_tex;
	}
