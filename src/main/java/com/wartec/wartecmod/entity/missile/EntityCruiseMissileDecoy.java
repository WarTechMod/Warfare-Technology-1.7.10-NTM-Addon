...
public class EntityCruiseMissileDecoy extends EntitySubsonicCruiseMissileBase {

    public EntityCruiseMissileDecoy(World p_i1582_1_) {
        super(p_i1582_1_);
    }

    public EntityCruiseMissileDecoy(World world, float x, float y, float z, int a, int b, int c, TileEntityVlsExhaust exhaust) {
    ...
    public void onImpact() {
        ...
        explosionLargeAdvanced.ExplosionAdvanced(worldObj, posX, posY, posZ, 2F, 2F, true, ModBlocks.block_slag, 1);
    }
