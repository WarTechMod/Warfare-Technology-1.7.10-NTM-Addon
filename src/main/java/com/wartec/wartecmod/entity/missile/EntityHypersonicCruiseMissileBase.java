...
public abstract class EntityHypersonicCruiseMissileBase extends Entity implements IChunkLoader, IRadarDetectable {
	...
	public EntityHypersonicCruiseMissileBase(World p_i1582_1_) {
		super(p_i1582_1_);
	...
	public EntityHypersonicCruiseMissileBase(World world, float x, float y, float z, int a, int b, int c) {
		super(world);
		this.ignoreFrustumCheck = true;
		/*this.posX = x;
		this.posY = y;
