...
public class EntitySupersonicCruiseMissileHE extends EntitySupersonicCruiseMissileBase {
	
	public EntitySupersonicCruiseMissileHE(World p_i1582_1_) {
		super(p_i1582_1_);
	}

	public EntitySupersonicCruiseMissileHE(World world, float x, float y, float z, int a, int b, int c) {
