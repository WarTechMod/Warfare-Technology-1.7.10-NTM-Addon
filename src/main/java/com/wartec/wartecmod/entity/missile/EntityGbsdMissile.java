...
public class  EntityGbsdMissile extends EntityBallisticMissileBase {
	...
	public void onImpact() {
    	...
    	worldObj.spawnEntityInWorld(EntityNukeExplosionMK5.statFac(worldObj, BombConfig.mikeRadius * 1, posX, posY, posZ));

		EntityNukeCloudSmall entity2 = new EntityNukeCloudSmall(this.worldObj, 1000, BombConfig.mikeRadius * 1 * 0.005F);
