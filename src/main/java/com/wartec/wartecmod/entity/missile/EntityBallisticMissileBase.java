...
public abstract class EntityBallisticMissileBase extends Entity implements IChunkLoader, IRadarDetectable {
	...
	public EntityBallisticMissileBase(World p_i1582_1_) {
		super(p_i1582_1_);
	...
	public EntityBallisticMissileBase(World world, float x, float y, float z, int a, int b) {
		super(world);
		this.ignoreFrustumCheck = true;
		/*this.posX = x;
		this.posY = y;
