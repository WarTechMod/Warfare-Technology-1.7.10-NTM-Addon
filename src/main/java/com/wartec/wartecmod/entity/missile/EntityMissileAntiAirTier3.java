...
public class EntityMissileAntiAirTier3 extends Entity implements IRadarDetectable {

	int activationTimer;

	public EntityMissileAntiAirTier3(World p_i1582_1_) {
		super(p_i1582_1_);
	}
	...
	public void onUpdate() {
		...
		if(activationTimer < 40) {
			...
			for(int i = 0; i < 5; i++) {
				...
				for(Entity e : list) {
					if(e instanceof EntityMissileCustom || e instanceof EntitySubsonicCruiseMissileBase || e instanceof EntitySupersonicCruiseMissileBase || e instanceof EntityHypersonicCruiseMissileBase) {
