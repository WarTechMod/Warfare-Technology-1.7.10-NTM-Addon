...
public class EntityCJ10Missile extends EntitySubsonicCruiseMissileBase {

	public EntityCJ10Missile(World p_i1582_1_) {
		super(p_i1582_1_);
	}

	public EntityCJ10Missile(World world, float x, float y, float z, int a, int b, int c, TileEntityVlsExhaust exhaust) {
	...
	public ItemStack getDebrisRareDrop() {
		return new ItemStack(wartecmodItems.itemCj10Missile);
	}
