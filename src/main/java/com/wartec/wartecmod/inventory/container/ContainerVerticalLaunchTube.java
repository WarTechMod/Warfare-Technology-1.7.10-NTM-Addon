...
public class ContainerVerticalLaunchTube extends Container {

    private TileEntityVerticalLaunchTubeBase launchtube;

    public ContainerVerticalLaunchTube(InventoryPlayer invPlayer, TileEntityVerticalLaunchTubeBase tedf) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int par2) {
        ...
        if(var4 != null && var4.getHasStack()) {
            ...
            if(par2 <= 6) {
                ...
                } else if(launchtube.isMissileValid(var3)) {
                ...
                } else if(FluidContainerRegistry.getFluidContent(var3, launchtube.tanks[0].getTankType()) > 0) {
                    if(!this.mergeItemStack(var5, 3, 4, false)) {
                        return null;
                    }
                } else if(FluidContainerRegistry.getFluidContent(var3, launchtube.tanks[1].getTankType()) > 0) {
    ...
    public boolean canInteractWith(EntityPlayer player) {
        return launchtube.isUseableByPlayer(player);
    }
}
