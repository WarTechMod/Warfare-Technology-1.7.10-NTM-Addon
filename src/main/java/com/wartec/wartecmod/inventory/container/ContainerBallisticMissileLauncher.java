...
public class ContainerBallisticMissileLauncher extends Container {
	
	private TileEntityBallisticMissileLauncher diFurnace;
	
	public ContainerBallisticMissileLauncher(InventoryPlayer invPlayer, TileEntityBallisticMissileLauncher tedf) {
