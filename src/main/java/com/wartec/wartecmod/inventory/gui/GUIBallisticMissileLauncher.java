...
public class GUIBallisticMissileLauncher extends GuiInfoContainer {
	...
	private TileEntityBallisticMissileLauncher diFurnace;

	public GUIBallisticMissileLauncher(InventoryPlayer invPlayer, TileEntityBallisticMissileLauncher tedf) {
		super(new ContainerBallisticMissileLauncher(invPlayer, tedf));
		diFurnace = tedf;
